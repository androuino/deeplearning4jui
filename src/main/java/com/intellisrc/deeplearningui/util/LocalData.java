...
public final class LocalData {
    public static final String[] COCO_CLASSES = {"person", "bicycle", "car", "motorbike", "aeroplane", "bus", "train",
    ...
    public static final String[] TINY_COCO_CLASSES = {"aeroplane", "bicycle", "bird", "boat", "bottle", "bus", "car",
            "cat", "chair", "cow", "diningtable", "dog", "horse", "motorbike", "person", "pottedplant",
            "sheep", "sofa", "train", "tvmonitor"};
    public static final String[] CUSTOMIZE_CLASSES = {"bridgestone", "dunlop", "goodyear", "yokohama"};
